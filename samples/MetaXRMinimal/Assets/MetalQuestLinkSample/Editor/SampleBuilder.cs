...
namespace MetalQuestLink.Sample.Editor
{
    ...
    {
        public const string ScenePath = "Assets/MetalQuestLinkSample/Scenes/Minimal.unity";
        ...
        public static void ConfigureAndBuild()
        {
            ...
            Debug.Log($"METALQUESTLINK_SAMPLE_READY scene={ScenePath} manifest={manifest}");
        }
