...
{
    [FilePath("ProjectSettings/MetalQuestLinkSettings.asset", FilePathAttribute.Location.ProjectFolder)]
    public sealed class MetalQuestLinkSettings : ScriptableSingleton<MetalQuestLinkSettings>
    {
