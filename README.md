...
現在はPhase 2まで実装済み。Apple Silicon向け共有プロトコル、OpenXR API layer、
Meta XR Simulatorで動くMetal native test client、VideoToolbox H.264映像送信とmacOS
mock viewerがある。進捗と実測結果は
...
両E2Eは `/Applications/MetaXRSimulator.app` のStandalone Meta XR Simulator v201以降を
