...
| 5 | 達成 | Editor package EditMode 4/4、Simulator PlayMode 1/1、Play時Quest client自動起動 |
...
- `com.maquestlink.editor-0.1.0.tgz` — 38,572,914 bytes — SHA-256 `e9810fd3b6446bbee339c6b5ffc4899d001cf8936a5e7ebcbed11c0f625ff38b`
- `MaQuestLink-0.1.0.apk` — 43,701,631 bytes — SHA-256 `4593a4c23604c3464d8e492d7c3fbc5b25c6ddd412c7c0d1a5a8538023f3cc75`
- `SHA256SUMS`
- `VERSION` (`0.1.0`)
...
2. Touch Plusを用意できたら振動の強度、周波数、duration停止を体感確認する。
